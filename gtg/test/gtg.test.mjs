...
// --- 41. undo is scoped to the calling session ---
...
// one checkout is the normal setup here, so this is the default case, not an edge.
{
  ...
  console.log('ok 41 - undo is scoped to the calling session');
}

// --- 42. supersede is neither a ship nor an abandonment ---
{
  const repo = tempRepo();
  ...
  console.log('ok 42 - supersede is neither a ship nor an abandonment');
}

// --- 43. a superseded slug stops counting as abandoned ---
{
  ...
  console.log('ok 43 - a superseded slug stops counting as abandoned');
}
