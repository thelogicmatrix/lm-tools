...
**A library of 39 lenses (9 general + 30 domain)**, each a small checklist grounded in one of 15 research-backed knowledge files (`references/res_*.md`, cited to primary standards — WCAG, OWASP, SRE, learning science, SemVer, data-protection, and more). Nothing loads until a lens is selected, so an unused lens costs no context.
