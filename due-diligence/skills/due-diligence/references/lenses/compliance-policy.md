...
## Severity guide
- blocker: PII or a secret actually leaves the machine (git, cloud API, external log), or a hard org or project policy is violated (a change committed outside the required branch or review path, durable output stranded in a disposable location).
